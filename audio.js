...
const SOUNDS = {
  ...
  hit:      () => synthTone({ freq: 180, endFreq: 120, duration: 0.07, gain: 0.20, type: 'sine' }),
  match:    () => synthArp([550, 700, 880],  0.12, 0.35),
  chain:    () => synthTone({ freq: 120, endFreq: 40, duration: 0.18, gain: 0.50, type: 'sine' }),
